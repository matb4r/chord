...
\begin{axis}[
    width=\textwidth,
    xlabel={MAX\_GROUP\_SIZE},
    ylabel={Śr. liczność grup},
    xmin=0, xmax=20,
    ymin=0, ymax=20,
...
\legend{STABILITY\_REQUIREMENT = 0.1, STABILITY\_REQUIREMENT = 0.5, STABILITY\_REQUIREMENT  = 0.9}

\end{axis}
\end{tikzpicture}


\caption{Wykres x.y: MAX\_GROUP\_SIZE a średnia liczność grup.}
\end{figure}
...
\legend{przyłaczenia/odłączenia = 0.1, przyłaczenia/odłączenia = 0.5, przyłaczenia/odłączenia = 0.9}

\end{axis}
\end{tikzpicture}


\caption{Wykres x.y: STABILITY\_REQUIREMENT a średnia liczność grup.}
\end{figure}
...
\begin{axis}[
    width=\textwidth,
    xlabel={Stosunek przyłaczeń do odłączeń},
    ylabel={Śr. liczność grup},
    xmin=0, xmax=1,
    ymin=0, ymax=10,
    legend pos=north west,
...
\caption{Wykres x.y: Stosunek przyłączeń do odłączeń a średnia liczność grup (1000 cykli, MAX\_GROUP\_SIZE=10).}
\end{figure}
