...
Protokół Chord jest prosty w swojej idei. Jego konstrukcja pozostawia duże pole do ewentualnych rozszerzeń. Sami autorzy zaproponowali kilka prostych usprawnień. Ponadto powstało wiele pomysłów jak rozszerzyć Chorda o dodatkowe funkcjonalności, takie jak replikacja danych. Są też rozwiązania, które korzystają z Chorda, dostosowywując go do swoich potrzeb. Sam motyw przewodni tej pracy bazuje na Chordzie, rozszerzając go o mechanizm grupowania wspierający replikację.
...
Ciekawym pomysłem jest mechanizm grupowania. Jest on bezpośrednią inspiracją dla protokołu Statycznych Grup, a więc wymaga szczególnego omówienia. Ponadto może działać w oderwaniu od protokołu Chord. Dlatego też mechanizmowi grupowania został poświęcony osobny rozdział (\ref{rozdzial_grupowanie}).
