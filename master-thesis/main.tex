...
Innym, istotnym w kontekście tej pracy, pomysłem jest mechanizm grupowania. Jest on bezpośrednią inspiracją dla protokołu Statycznych Grup, a więc wymaga szczególnego omówienia; ponadto może działać w oderwaniu od protokołu Chord; dlatego też mechanizmowi grupowania został poświęcony osobny rozdział (\ref{rozdzial_grupowanie}).
